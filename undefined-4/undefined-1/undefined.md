...
* **구역/팀/역할 설정**: \
  참가자들을 특정 구역이나 팀으로 배분할 수 있고 참가자마다 다른 역할을 부여 할 수 있다.
* **자동 및 수동 배치**: \
  사전 규칙에 따른 자동 배치와 개별 조정을 위한 수동 배치 기능
...
* 개인 속성으로 [\[접근 권한\],\[보기 필터\]](broken-reference) 를 걸어 다양한 인터랙션이 가능합니다.
...
* **역할 상세 설정 :**
  * 역할 상세 설정은 \[[**구역 및 팀 상세 설정**](undefined.md#undefined-3)]과 동일 합니다.
