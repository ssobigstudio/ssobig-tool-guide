...
한 방에 8명의 플레이어(A 구역) 있으며, **팀 1과 팀 2**로 나뉘어 있습니다.\
각 팀에는 **남녀 2명씩** 포함되어 있으며, **우리가 주목할 플레이어는 A 남자(팀 1 소속)**&#xC785;니다.

* **팀 1 구성**: A 남자, A 여자, C 여자, D 남자
* **팀 2 구성**: B 남자, B 여자, E 여자, F 남자

#### **목표**

A 남자가 **자신의 팀 내에서만 이성(여자)을 투표 선택지로 볼 수 있도록 설정**합니다.

#### **필터 시스템 설정**

1. **유형**: 성별 → **대상**: 이성 → **조건**: 경우에만
2. **AND**
3. **유형**: 팀 → **대상**: 내 팀 → **조건**: 경우에만

#### **결과**

필터를 적용하지 않으면 **모든 팀의 남녀가 선택지에 표시**되지만,\
**필터 적용 후 팀 1의 이성(A 여자, C 여자)만 선택지에 표시**됩니다.

이렇게 설정하면 플레이어는 **자신의 팀 내 이성 플레이어만 선택 가능**합니다.
